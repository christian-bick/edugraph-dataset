...
Its public `metadata.jsonl` contains only the image path, ontology labels, and a `solution` flag; richer operational metadata remains in the per-standard datasets.
