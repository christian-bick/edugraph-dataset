...
interface CountingPlaceValueOffsetViewProps {
    expectedStepSize: PlaceValueOffsetStep;
    payload: ViewRenderPayload<PlaceValueOffsetViewId>;
...
export function CountingPlaceValueOffsetView({
    expectedStepSize,
    payload,
    viewId
}: CountingPlaceValueOffsetViewProps) {
    ...
    const analysis = analyzePlaceValueOffsetProblem(data, expectedStepSize, viewId);
