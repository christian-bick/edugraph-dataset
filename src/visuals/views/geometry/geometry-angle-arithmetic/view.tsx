...
interface CoreProps {
    config: GeometryAngleArithmeticViewConfig;
    payload: ViewRenderPayload<'geometry-angle-arithmetic'>;
}
...
export const GeometryAngleArithmetic = withConfig(
    GeometryAngleArithmeticViewSchema,
    GeometryAngleArithmeticCore
);
