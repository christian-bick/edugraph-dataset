...
import {operationSymbol, writtenDigits} from './place-value-arithmetic-model-helpers.ts';
import {regroupingPresentation} from './place-value-arithmetic-presentation.ts';

interface CoreProps {
    mode: PlaceValueArithmeticModelMode;
    payload: ViewRenderPayload<PlaceValueArithmeticModelViewId>;
    viewId: PlaceValueArithmeticModelViewId;
}

export type PlaceValueArithmeticModelMode = 'blocks' | 'written-method';
export type PlaceValueArithmeticModelViewId =
    | 'place-value-arithmetic-model'
    | 'place-value-arithmetic-written-method';
