...
- **Resolver Reusability and Definition:** All ontology resolver helpers (e.g., `hasLabel`, `selectExactMatch`, `extractFirstMatch`) must be imported and reused from [resolvers.ts](file:///c:/Users/silen/Documents/EduGraph/edugraph-content/src/lib/resolvers.ts). Do not declare ad-hoc resolvers locally in `spec.ts` files.
...
- 🟢 **Good (Strictly visual/representation parameters):**
  ...
  export const CountingViewSchema = {
      ...
      ] // Visual layout/arrangement of objects
  };
  ```
