...
| `decimal-comparison` | 3/1 | **Migrated except explicit model-boundary review:** retains operand precision, numeric place-value decomposition, normalized values, relation, first deciding place, and the existing hundred-grid models. The view derives operand roles, decimal notation, normalized notation, place-value rows, the comparison symbol, equations, answer statement, and explanation. Whether the hundred-grid models themselves are canonical evidence or a view projection remains one of the three recorded hard decisions. |
...
| `fraction-equivalence` | 9 | `fractions-equivalence-completion-model`, `fractions-equivalence-explanation-model`, `fractions-equivalence-model`, `fractions-whole-equivalence`, `numbers-fraction-line`, `numbers-fraction-line-classification`, `numbers-fraction-line-explanation`, `numbers-fraction-line-formalization` | **Migrated except explicit model-boundary review:** retains rational values, scale factors, equality, shared-whole identity, and the existing grid models; views derive notation, equations, scaling narration, and completion direction. Whether the grid models themselves are canonical mathematics or view projections remains one of the three recorded hard decisions. |
