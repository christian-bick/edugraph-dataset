...
| `fraction-comparison` | 7/2 | **Migrated:** common-component comparisons retain the fractions, family, shared component, relation, and shared whole; unlike comparisons retain typed half-benchmark relations and bar models. Views derive symbols, equations, answers, prompts, benchmark statements, and rationale. |
